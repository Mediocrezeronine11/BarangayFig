...
// Search logic for barangay clearance
$searchQuery = "";
...
// Barangay clearance request query
$clearance_query = "
    SELECT 
        id,            
        code,         
        ...
        status         -- Fetching the status column
    FROM barangay_clearance
    $searchQuery
    ORDER BY request_date DESC
";

$clearance_result = mysqli_query($con, $clearance_query);

// Check if query succeeded
if (!$clearance_result) {
    die("Barangay clearance query failed: " . mysqli_error($con));
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['clearance_id'])) {
    ...
    $sql = "UPDATE barangay_clearance SET status='$new_status' WHERE id='$clearance_id'";
    ...
    header("Location: bclearance.php");
    exit();
}
...
<li class="sidebar-menu-devider mt-3 mb-1 text-uppercase pb-2">Online processing</li>
        <li class="sidebar-menu-item has-dropdown ">
            ...
            <li class="sidebar-dropdown-menu-item" style="background-color: #008080; border: 2px solid #ffffff; border-radius: 8px;">
                    <a href="bclearance.php"  style="color: white; text-decoration: none; display: block; padding: 5px;">
                       Barangay Clearance
                    </a>
                </li>
...
<main class="bg-light">
    ...
    <i class="ri-menu-line sidebar-toggle me-3 mt-2 d-block d-md-none"></i>
        ...
        <h5 class="fw-bold mb-0 mt-2 me-auto text-dark">Barangay Clearance</h5>
    ...
    <form method="POST" action="bclearance.php">
    ...
    <div class="bg-white rounded shadow-sm p-4">
        ...
        <table class="table text-center">
            ...
            <tbody>
                <?php
                if ($clearance_result && mysqli_num_rows($clearance_result) > 0) {
                    while ($row = mysqli_fetch_assoc($clearance_result)) {
                        ...
                        echo "<td>
                                <form action='bclearance.php' method='POST' class='mb-4 d-flex justify-content-center'>
                                    <input type='hidden' name='clearance_id' value='" . $row['id'] . "'>
